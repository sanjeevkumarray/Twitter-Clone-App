...
const TweetBox = () => {
    ...
    const handleTweet = (event)=>{
        ...
        setTweets([{'title': 'Sanjeev kumar ray', "message": input, "time": timestamp, "image": secondInput} , ...tweets]);
                ...
                <div className="post-header">
                    <div className="post-headerText">
                        <h3>{tweet.title} 
                            ...
                            <VerifiedUserIcon className='post-badge'/> @sanjeevkumarray  {tweet.time}
                            </span>
                        </h3>
                    </div>
